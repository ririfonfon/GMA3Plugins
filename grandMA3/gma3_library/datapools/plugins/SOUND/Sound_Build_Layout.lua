...
function Build_Layout(Construct_Pool, Name_Layout)
    ...
    local titre_x = {
        -400, -400, -400, -350, 200, 750, 1300,
        -400, -400, -400, -350, 200, 750, 1300,
        -400, -400, -400, -350, 200, 750 }
    local titre_y = {
        100, 50, 0, 150, 150, 150, 150,
        -100, -150, -200, -50, -50, -50, -50,
        -300, -350, -400, -250, -250, -250 }
    local titre_w = { 50, 50, 50, 500, 500, 500, 500, 50, 50, 50, 500, 500, 500, 500, 50, 50, 50, 500, 500, 500 }
    local texte = { 'P1', 'P2', 'P3', 'Sound All', 'Sound Bass', 'Sound Mid', 'Sound High', 'P1', 'P2', 'P3',
        'Sound Band 1', 'Sound Band 2', 'Sound Band 3', 'Sound Band 4', 'P1', 'P2', 'P3', 'Sound Band 5', 'Sound Band 6',
        'Sound Band 7' }

    local macro_x = {
        -350, -250, -150, -50, 50, -350, -250, -150, -50, 50, -350, -250, -150, -50, 50,
        200, 300, 400, 500, 600, 200, 300, 400, 500, 600, 200, 300, 400, 500, 600,
        750, 850, 950, 1050, 1150, 750, 850, 950, 1050, 1150, 750, 850, 950, 1050, 1150,
        1300, 1400, 1500, 1600, 1700, 1300, 1400, 1500, 1600, 1700, 1300, 1400, 1500, 1600, 1700,
        -350, -250, -150, -50, 50, -350, -250, -150, -50, 50, -350, -250, -150, -50, 50,
        200, 300, 400, 500, 600, 200, 300, 400, 500, 600, 200, 300, 400, 500, 600,
        750, 850, 950, 1050, 1150, 750, 850, 950, 1050, 1150, 750, 850, 950, 1050, 1150,
        1300, 1400, 1500, 1600, 1700, 1300, 1400, 1500, 1600, 1700, 1300, 1400, 1500, 1600, 1700,
    ...
    local macro_y = {
        100, 100, 100, 100, 100, 50, 50, 50, 50, 50, 0, 0, 0, 0, 0,
        100, 100, 100, 100, 100, 50, 50, 50, 50, 50, 0, 0, 0, 0, 0,
        100, 100, 100, 100, 100, 50, 50, 50, 50, 50, 0, 0, 0, 0, 0,
        100, 100, 100, 100, 100, 50, 50, 50, 50, 50, 0, 0, 0, 0, 0,
        -100, -100, -100, -100, -100, -150, -150, -150, -150, -150, -200, -200, -200, -200, -200,
        -100, -100, -100, -100, -100, -150, -150, -150, -150, -150, -200, -200, -200, -200, -200,
        -100, -100, -100, -100, -100, -150, -150, -150, -150, -150, -200, -200, -200, -200, -200,
        -100, -100, -100, -100, -100, -150, -150, -150, -150, -150, -200, -200, -200, -200, -200,
        -300, -300, -300, -300, -300, -350, -350, -350, -350, -350, -400, -400, -400, -400, -400,
        -300, -300, -300, -300, -300, -350, -350, -350, -350, -350, -400, -400, -400, -400, -400,
        -300, -300, -300, -300, -300, -350, -350, -350, -350, -350, -400, -400, -400, -400, -400
    }
    ...
    for i = 1, 20 do
        ...
        Layout_Object[Layout_Nr][Nr.No]:Set('height', 50)
        Layout_Object[Layout_Nr][Nr.No]:Set('action', 'None')
        Layout_Object[Layout_Nr][Nr.No]:Set('Note', 'FOND')
