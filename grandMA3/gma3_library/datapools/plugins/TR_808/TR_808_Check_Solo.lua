...
function Check_Solo()
    ...
    if P_Order == "A" then
        ...
        if P_A_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "a_SOLO')
        end
    ...
    elseif P_Order == "B" then
        ...
        if P_B_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "b_SOLO')
        end
    ...
    elseif P_Order == "C" then
        ...
        if P_C_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "c_SOLO')
        end
    ...
    elseif P_Order == "D" then
        ...
        if P_D_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "d_SOLO')
        end
    ...
    elseif P_Order == "E" then
        ...
        if P_E_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "e_SOLO')
        end
    ...
    elseif P_Order == "F" then
        ...
        if P_F_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "f_SOLO')
        end
    ...
    elseif P_Order == "G" then
        ...
        if P_G_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "g_SOLO')
        end
    ...
    elseif P_Order == "H" then
        ...
        if P_H_TR_Solo < 1 then
            ...
            Cmd('Go+ DataPool "' .. TR_Pool ..'" Macro "h_SOLO')
        end
