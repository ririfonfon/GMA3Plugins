...
local function Build_Macro_Varia()

    local count = 1
    local varia_min = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h' }
    local varia_mag = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' }
    local MacroNum = 4
    local MacroEnd = MacroNum + 7
    local subSel = 1
    local VariaSel = 1
    ...
    for i = MNum_Play, MEnd_Play, 1 do
        ...
        MacroObject[i][1]:Set('Command',
            "Goto Cue 3 DataPool '" .. Build_Pool.Name .. "' Sequence Thru if Tag 'Variation_Play'")
    ...
    for i = MNum_Call, MEnd_Call, 1 do
        ...
        MacroObject[i][1]:Set('Command',
            "Go+ DataPool '" .. Build_Pool.Name .. "' Macro 'Tempo_Reset']")
        MacroObject[i][2]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#1'." .. count .. " 'Enabled' 1")
        MacroObject[i][3]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#2'." .. count .. " 'Enabled' 1")
        MacroObject[i][4]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#3'." .. count .. " 'Enabled' 1")
        MacroObject[i][5]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#4'." .. count .. " 'Enabled' 1")
        MacroObject[i][6]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#5'." .. count .. " 'Enabled' 1")
        MacroObject[i][7]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#6'." .. count .. " 'Enabled' 1")
        MacroObject[i][8]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#7'." .. count .. " 'Enabled' 1")
        MacroObject[i][9]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#8'." .. count .. " 'Enabled' 1")
        MacroObject[i][10]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#9'." .. count .. " 'Enabled' 1")
        MacroObject[i][11]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#10'." .. count .. " 'Enabled' 1")
        MacroObject[i][12]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#11'." .. count .. " 'Enabled' 1")
        MacroObject[i][13]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#12'." .. count .. " 'Enabled' 1")
        MacroObject[i][14]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#13'." .. count .. " 'Enabled' 1")
        MacroObject[i][15]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#14'." .. count .. " 'Enabled' 1")
        MacroObject[i][16]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#15'." .. count .. " 'Enabled' 1")
        MacroObject[i][17]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Tempo_#16'." .. count .. " 'Enabled' 1")
        MacroObject[i][18]:Set('Command', "Go+ DataPool '" ..
            Build_Pool.Name .. "' Macro 'Varia_" .. varia_mag[VariaSel] .. "_Play'")
        subSel = subSel + 1
        count = count + 1
        VariaSel = VariaSel + 1
    end
    ...
    MacroObject[nr_P][3]:Set('Command', "Go+ DataPool '" .. Build_Pool.Name ..
        "' Macro 'Varia_C_Play'")
    MacroObject[nr_P][3]:Set('Enabled', 0)
    MacroObject[nr_P][4]:Set('Command', "Go+ DataPool '" .. Build_Pool.Name ..
        "' Macro 'Varia_D_Play'")
    MacroObject[nr_P][4]:Set('Enabled', 0)
    MacroObject[nr_P][5]:Set('Command', "Go+ DataPool '" .. Build_Pool.Name ..
        "' Macro 'Varia_E_Play'")
    MacroObject[nr_P][5]:Set('Enabled', 0)
    MacroObject[nr_P][6]:Set('Command', "Go+ DataPool '" .. Build_Pool.Name ..
        "' Macro 'Varia_F_Play'")
    MacroObject[nr_P][6]:Set('Enabled', 0)
    MacroObject[nr_P][7]:Set('Command', "Go+ DataPool '" .. Build_Pool.Name ..
        "' Macro 'Varia_G_Play'")
    ...
    for i = MNum_V, MEnd_V, 1 do
        ...
        MacroObject[i][1]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Varia_Call'." .. count .. " 'Enabled' 1")
        MacroObject[i][2]:Set('Command',
            "Set DataPool '" .. Build_Pool.Name .. "' Macro 'Varia_Call'.9 'Enabled' 1")
        MacroObject[i][3]:Set('Command',
            "Set DataPool '" .. Build_Pool.Name .. "' Macro 'Varia_Current'.1 Thru 8 'Enabled' 0")
        MacroObject[i][4]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Varia_Current'." .. count .. " 'Enabled' 1")
        MacroObject[i][5]:Set('Command',
            "Set DataPool '" .. Build_Pool.Name .. "' Macro 'Varia_Play'.1 Thru 8 'Enabled' 0")
        MacroObject[i][6]:Set('Command', "Set DataPool '" ..
            Build_Pool.Name .. "' Macro 'Varia_Play'." .. count .. "  'Enabled' 1")
        subSel = subSel + 1
        count = count + 1
        VariaSel = VariaSel + 1
    end
    ...
    for i = MNum_E, MEnd_E, 1 do
        ...
        MacroObject[i][3]:Set('Command', "Go+ DataPool '" ..
            Build_Pool.Name .. "' Macro 'all_sub_varia_" .. varia_min[VariaSel] .. "'")
