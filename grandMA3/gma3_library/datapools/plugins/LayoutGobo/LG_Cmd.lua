...
local function CreateSequence(SeqNameF, Preset_Name1F, Preset_Name2F, Preset_Name3F, GroupNum, Grp, Slot_ID1, Slot_ID2,
                              Slot_ID3)
    ...
    CmdIndirectWait("store seq '" .. SeqNameF .. "' cue 1 t " .. length1 + length2 + length3 - 2 .. " /nc")
