...
function get_first_pool_num(object_amount,pool)
    local object_num = 1
    local i = 1
...
function get_suitable_user_input(msg, placeholder)
    local userInput = ''
    repeat
...
function check_selected_pool_num(message,suggested,object_amount,pool)
    local result = false
