...
function layout_align_matrx(last_obj, size_x, size_y,gap_x,gap_y,start_pos_x,start_pos_y,first_mtrx,number_of_presets,amount_of_groups,cp_layout,progress_bar_time,DP)
