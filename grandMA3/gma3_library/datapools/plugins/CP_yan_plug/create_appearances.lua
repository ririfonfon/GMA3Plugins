...
function create_appearances(selected_presets, presets_R, presets_G, presets_B, first_appear,in_declared_timings,half_second,naming_prefix,progress_bar_time,DP)
    --[[
