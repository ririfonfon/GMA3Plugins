...
function create_delete_macro(first_macro,last_macro,first_sequence,number_of_presets,amount_of_groups,cp_layout,first_appear,last_appear,first_preset,first_matrx,choise,name_prefix,DP)
