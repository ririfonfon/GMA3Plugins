...
function layout_align_timing_macros(last_obj, timing_macros_amount_lay,first_macro, size_x, size_y,gap_x,gap_y,start_pos_x,start_pos_y,amount_of_groups,cp_layout,name_prefix,progress_bar_time,DP)
