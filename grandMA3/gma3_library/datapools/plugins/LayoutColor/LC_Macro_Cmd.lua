...
function LC_Create_Macro_Reset(CurrentMacroNr, prefix, surfix, MatrickNrStart, Axes, CurrentSeqNr,First_Id_Lay, TLayNr, Fade_Element,
    ...
    MacroObject[CurrentMacroNr + 1][23]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][31]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][39]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][47]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][55]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][63]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
    ...
    MacroObject[CurrentMacroNr + 1][71]:Set('Command', 'Call ' .. Call_Pool .. ' Plugin "DEV_LC_View"')
