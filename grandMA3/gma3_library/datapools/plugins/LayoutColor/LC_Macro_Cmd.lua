...
function LC_Create_Macro_Reset(CurrentMacroNr, prefix, surfix, MatrickNrStart, Axes, CurrentSeqNr, First_Id_Lay, TLayNr,
    ...
    MacroObject[CurrentMacroNr + 1][19]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][26]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][34]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][42]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][50]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][58]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr + 1][66]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
...
function LC_Create_Macro_Delay_From(CurrentMacroNr, prefix, surfix, Axes, FirstSeq, LastSeq, MatrickNrStart, fonct, TLayNr,
...
function LC_Create_Macro_Delay_To(CurrentMacroNr, prefix, surfix, Axes, FirstSeq, LastSeq, MatrickNrStart, fonct, TLayNr, LayNr,
...
function LC_Create_Macro_Phase(CurrentMacroNr, prefix, surfix, Axes, MatrickNrStart, fonct, TLayNr, LayNr, MatrickNr,
...
function LC_Create_Macro_Group(CurrentMacroNr, prefix, surfix, Axes, FirstSeq, LastSeq, MatrickNrStart, fonct, TLayNr, LayNr,
                            MatrickNr, Construct_Pool, Call_Pool)
    local MacroObject, SequenceObject, Layout_Object, Nr = LC_Get_Object(Construct_Pool)
...
function LC_Create_Macro_Block(CurrentMacroNr, prefix, surfix, Axes, FirstSeq, LastSeq, MatrickNrStart, fonct, TLayNr, LayNr,
                            MatrickNr, Construct_Pool, Call_Pool)
    local MacroObject, SequenceObject, Layout_Object, Nr = LC_Get_Object(Construct_Pool)
...
function LC_Create_Macro_Wings(CurrentMacroNr, prefix, surfix, Axes, FirstSeq, LastSeq, MatrickNrStart, fonct, TLayNr, LayNr,
                            MatrickNr, Construct_Pool, Call_Pool)
    local MacroObject, SequenceObject, Layout_Object, Nr = LC_Get_Object(Construct_Pool)
...
function Create_Macro_Fade_E(CurrentMacroNr, prefix, Argument_Fade, i, surfix, Axes, FirstSeqTime, LastSeqTime, CurrentSeqNr,
    ...
    MacroObject[CurrentMacroNr][6]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
...
function LC_Add_Macro_Call(Axes, TLayNr, Fade_Element, MatrickNrStart, Delay_F_Element, Delay_T_Element, Phase_Element,
    ...
    MacroObject[CurrentMacroNr][34]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][41]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][48]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][55]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][62]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][69]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
    ...
    MacroObject[CurrentMacroNr][76]:Set('Command', 'SetUserVariable "LC_Axes" ' .. Axes .. '')
