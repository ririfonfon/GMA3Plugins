...
local function Main(display_Handle)
    ...
    for i = 1,5 do 
        ...
        if i == 1 then
            LayNr = Maf(LayNr + 1)
            Command_Title('X GROUP',LayNr,TLayNr,LayX,LayY,580,140)
        end    
        LayX = Maf(LayX + LayW + 20)
        LayNr = Maf(LayNr + 1)
        CurrentSeqNr = Maf(CurrentSeqNr + 1)
    ...
    for i = 1,5 do 
        ...
        if i == 1 then
            LayNr = Maf(LayNr + 1)
            Command_Title('XBLOCK',LayNr,TLayNr,LayX,LayY,580,140)
        end    
        LayX = Maf(LayX + LayW + 20)
        LayNr = Maf(LayNr + 1)
        CurrentSeqNr = Maf(CurrentSeqNr + 1)
    ...
    for i = 1,5 do 
        ...
        if i == 1 then
           LayNr = Maf(LayNr + 1)
           Command_Title('XWINGS',LayNr,TLayNr,LayX,LayY,580,140)
       end    
       LayX = Maf(LayX + LayW + 20)
       LayNr = Maf(LayNr + 1)
       CurrentSeqNr = Maf(CurrentSeqNr + 1)
