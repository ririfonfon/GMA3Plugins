...
local function Main(display_handle)
  ...
  for g in ipairs(SelectedGrp) do
     ...
     Cmd("Set Layout "..TLayNr.."."..LayNr.."Action=0 Appearance="..AppNr.."Name "..SelectedGrp[g].." PosX "..LayX.." PosY "..LayY.." PositionW "..LayW.." PositionH "..LayH.." Objectname=1 Bar=0 IndicatorBar=Background")
     ...
     for col in ipairs(TCol) do
         ...
         -- Create Sequences
         Cmd("clearall;Store Sequence "..SeqNrStart.." \""..StColName.." "..SelectedGrp[g].."\"")
         -- Create Macros
         Cmd("Store Macro "..MacroNrStart..".1 Thru "..MacroNrStart.."."..MacroIndex)
         Cmd("Label Macro "..MacroNrStart.." \""..StColName.." "..SelectedGrp[g].."\"")
         ...
         -- Add Cmd to Squence
         if(g==1) then
             Cmd("set seq "..SeqNrStart.." cue \"CueZero\" cmd=\"Set Layout "..TLayNr.."."..LayNr.." Appearance="..NrNeed.."; Macro "..MacroNrStart.."; Off Sequence "..Start_Seq_1.." Thru "..End_Seq_1.." - "..SeqNrStart.."\"")
         elseif(g==2) then
             Cmd("set seq "..SeqNrStart.." cue \"CueZero\" cmd=\"Set Layout "..TLayNr.."."..LayNr.." Appearance="..NrNeed.."; Macro "..MacroNrStart.."; Off Sequence "..Start_Seq_2.." Thru "..End_Seq_2.." - "..SeqNrStart.."\"")
         elseif(g==3) then
             Cmd("set seq "..SeqNrStart.." cue \"CueZero\" cmd=\"Set Layout "..TLayNr.."."..LayNr.." Appearance="..NrNeed.."; Macro "..MacroNrStart.."; Off Sequence "..Start_Seq_3.." Thru "..End_Seq_3.." - "..SeqNrStart.."\"")
         elseif(g==4) then
             Cmd("set seq "..SeqNrStart.." cue \"CueZero\" cmd=\"Set Layout "..TLayNr.."."..LayNr.." Appearance="..NrNeed.."; Macro "..MacroNrStart.."; Off Sequence "..Start_Seq_4.." Thru "..End_Seq_4.." - "..SeqNrStart.."\"")
         end
