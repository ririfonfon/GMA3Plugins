...
local function MyMain(display_handle)
    ...
    local DisplayPath =
        root.GraphicsRoot.PultCollect[1].DisplayCollect:Children()
    ...
    local intImageNr
    for k in pairs(tblImages) do intImageNr = k end
    if intImageNr == nil then intImageNr = 0 end
    local tbkImageImport = {
        {
            Name = "\"White-on\"",
            FileName = "\"white-on.png\"",
            Filepath = "\"../lib_plugins/CreateColorLayout/images\""
        }, {
            Name = "\"White-off\"",
            FileName = "\"white-off.png\"",
            Filepath = "\"../lib_plugins/CreateColorLayout/images\""
        }
    }
    ...
    local intAppNr
    for k in pairs(tblAppearances) do intAppNr = k end

    -- same same with Layout
    local tblLayout = root.ShowData.DataPools.Default.Layouts:Children()
    local tblLayoutNr
    for k in pairs(tblLayout) do tblLayoutNr = k end
    ...
    local box = MessageBox({
        ...
        message = Message,
        commands = {
            {name = 'Cancel', value = 0}, {name = 'Add Group', value = 11},
            {name = ColorGelButton, value = 12}, {name = 'Ok GO!', value = 1}
        },
        inputs = {{name = SeqNrText, value = SeqNrStart, maxTextLength = 3}}
    });
    ...
    intSelGroup = PopupInput("Select Fixture Group", display_handle,
                             tblGroupChoise, "", DisplayMidW, DisplayMidH);
    table.insert(SelectedGroup,
                 "'" .. FixtureGroups[intSelGroup + 1].name .. "'")
    ...
    -- Setup the Messagebox
    selColorGel = PopupInput("Select ColorGel", display_handle, choiseGel, "",
                             DisplayMidW, DisplayMidH);
    SelectedGel = ColorGels[selColorGel + 1].name;
    SelectedGelNr = selColorGel + 1
    Printf("ColorGel " .. ColorGels[selColorGel + 1].name .. " selected")
    ColorGelButton = "ColorGel " .. ColorGels[selColorGel + 1].name ..
                         " selected"
    goto MainBox
    ---- End ColorGel	
    ...
    Cmd("Store Image 3." .. intImageNr .. " " .. tbkImageImport[1].Name ..
            " Filename=" .. tbkImageImport[1].FileName .. " filepath=" ..
            tbkImageImport[1].Filepath .. "")
    intImageNr = math.floor(intImageNr + 1);
    Cmd("Store Image 3." .. intImageNr .. " " .. tbkImageImport[2].Name ..
            " Filename=" .. tbkImageImport[2].FileName .. " filepath=" ..
            tbkImageImport[2].Filepath .. "")
    ---- End Images  
    ...
    for g in ipairs(SelectedGroup) do
        ...
        if (intAppCreatet == 0) then
            ...
            Cmd(
                "Store App " .. intAppNr .. " \"Label\" Appearance=" .. strAppOn ..
                    " color=\"0,0,0,1\"")
        ...
        Cmd("Set Layout " .. tblLayoutNr .. "." .. intLayoutElementNr ..
                "Action=0 Appearance=" .. intAppNr .. " Positionx=" ..
                intLayoutElementX .. " Positiony=" .. intLayoutElementY ..
                " Positionw=" .. intLayoutElementW .. " Positionh=" ..
                intLayoutElementH .. " Objectname=1 bar=0")

        intLayoutElementNr = math.floor(intLayoutElementNr + 1)
        intLayoutElementX = math.floor(intLayoutElementX + intLayoutElementW +
                                           20)
        for col in ipairs(tblColors) do
            strColorCode =
                "\"" .. tblColors[col].r .. "," .. tblColors[col].g .. "," ..
                    tblColors[col].b .. ",1\""
            ...
            if (intAppCreatet == 0) then
                ...
                Cmd("Store App " .. intAppNrSeq .. " " .. strAppNameOn ..
                        " Appearance=" .. strAppOn .. " color=" .. strColorCode ..
                        "")
                intAppNrSeq = math.floor(intAppNrSeq + 1);
                Cmd("Store App " .. intAppNrSeq .. " " .. strAppNameOff ..
                        " Appearance=" .. strAppOff .. " color=" .. strColorCode ..
                        "")
                intAppNrSeq = math.floor(intAppNrSeq + 1);
            end
            -- end Appearances
            ...
            -- Create Sequences
            Cmd("clearall;Group " .. SelectedGroup[g] .. " at Gel " ..
                    intColornr .. ";Store Sequence " .. SeqNrStart .. " \"" ..
                    strColorName .. " " .. SelectedGroup[g]:gsub('\'', '') ..
                    "\"")
            -- Add Cmd to Squence
            Cmd(
                "set seq " .. SeqNrStart .. " cue \"CueZero\" cmd=\"Set Layout " ..
                    tblLayoutNr .. "." .. intLayoutElementNr .. " Appearance=" ..
                    intAppNrNeed .. "\"")
            Cmd(
            ...
            Cmd("Set Layout " .. tblLayoutNr .. "." .. intLayoutElementNr ..
                    " appearance=" .. intAppNrNeed + 1 .. " Positionx=" ..
                    intLayoutElementX .. " Positiony=" .. intLayoutElementY ..
                    " Positionw=" .. intLayoutElementW .. " Positionh=" ..
                    intLayoutElementH .. " Objectname=0 bar=0")

            intAppNrNeed = math.floor(intAppNrNeed + 2); -- Set App Nr to next color
            intLayoutElementX = math.floor(
                                    intLayoutElementX + intLayoutElementW + 20)
